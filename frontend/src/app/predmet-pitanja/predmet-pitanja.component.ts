...
@Component({
  selector: 'app-predmet-pitanja',
  templateUrl: './predmet-pitanja.component.html',
  styleUrls: ['./predmet-pitanja.component.css']
})
export class PredmetPitanjaComponent implements OnInit {
