...
export class RtiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,1).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,2).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,3).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,4).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,5).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,6).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,7).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(1,8).subscribe((subjects:Subject[])=>{
  ...
  goTo(subject:Subject){
    ...
    if(localStorage.getItem('type')=='admin' || localStorage.getItem('type')=='employee' || (localStorage.getItem('type')=='student' && mySubject)){
      ...
      localStorage.setItem('lastPage','/rti');
