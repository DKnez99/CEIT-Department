 import { Component, OnInit } from '@angular/core';
  ...
  @Component({
    selector: 'app-admin-dodaj-studenta',
    templateUrl: './admin-dodaj-studenta.component.html',
    styleUrls: ['./admin-dodaj-studenta.component.css']
  })
  
  export class AdminDodajStudentaComponent implements OnInit {
              ...
              if(!student){
                this.studentService.register(this.username, this.password, this.index, this.tipStud, this.ime, this.prezime).subscribe((student:Student)=>{
                  if(!student){
                    ...
                    this.errorMsg='';
                    this.successMsg='Studentski nalog je kreiran';
                    return;
                  }
                })
              }
                ...
                this.successMsg='';
                this.errorMsg='Već postoji studentski nalog sa korisničkim imenom '+this.username;
                return;
              }
            })
          }
