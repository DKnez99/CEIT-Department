...
export class OstaliComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,1).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,2).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,3).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,4).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,5).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,6).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,7).subscribe((subjects:Subject[])=>{
    ...
    this.subjectService.getAllSubjectsDepartmentSemester(3,8).subscribe((subjects:Subject[])=>{
  ...
  goTo(subject:Subject){
    ...
    if(localStorage.getItem('type')=='admin' || localStorage.getItem('type')=='employee' || (localStorage.getItem('type')=='student' && mySubject)){
      ...
      localStorage.setItem('lastPage','/ostali_odseci');
