...
@Component({
  selector: 'app-predmet-predavanja',
  templateUrl: './predmet-predavanja.component.html',
  styleUrls: ['./predmet-predavanja.component.css']
})
export class PredmetPredavanjaComponent implements OnInit {
